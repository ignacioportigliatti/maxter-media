import { FileUpload, FolderUpload, Input, Select, TextArea } from "@/app/components/ui/form";
import { Agency, Group } from "@prisma/client";
import axios from "axios";
import { useEffect, useState } from "react";
import { ToastContainer, toast } from "react-toastify";

interface UploadFormVideoProps {
  editMode?: boolean;
  handleEditGroup?: () => Promise<string>;
  getGroups?: () => void;
}

export const UploadFormVideo = (props: UploadFormVideoProps) => {
  const { editMode, handleEditGroup } = props;
